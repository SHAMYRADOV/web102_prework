...
const explanationString =
  numberOfUnfundedGames > 0
    ? `Total raised $${totalPledged.toLocaleString()} for ${totalGames} game${
        totalGames === 1 ? "" : "s"
      }.
    ${numberOfUnfundedGames} game${
        numberOfUnfundedGames === 1 ? " is" : "s are"
      } still unfunded.`
...
explanationElement.innerHTML = explanationString;
